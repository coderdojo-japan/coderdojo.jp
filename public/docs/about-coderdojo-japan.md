...
- **(1) 日本国内の「CoderDojo」の設立及び運営の支援**
   ...
   - 実例: [🛠 Upgrade Ruby on Rails: 7.2 &rarr; 8.0 #1693 - GitHub](https://github.com/coderdojo-japan/coderdojo.jp/pull/1693)
   - 実例: [🛠 Add inactivated_at to Dojo model to replace is_active boolean column #1726 - GitHub](https://github.com/coderdojo-japan/coderdojo.jp/pull/1726)<br><br>
...
- **(3) 日本国内の各「CoderDojo」と国外の「CoderDojo」との連携、協力に関する支援**
   ...
   - 詳細: [Facebook グループ](https://www.facebook.com/groups/coderdojo.jp)の運営、カンファレンスの開催サポートなど
   - 実例: [☯️ DecaDojo](https://decadojo.coderdojo.jp/)、[DojoCon Japan](https://dojocon.coderdojo.jp/)、[Coolest Projects Japan](https://coolestprojects2026.coderdojo.jp/)
   - 実例: [☯️ CoderDojo のオープンデータが、デジタル庁が推進する地域の Well-Being 指標のデジタル生活指数に採用 - Facebook](https://www.facebook.com/groups/coderdojo.jp/permalink/24963750126645051/)<br><br>
...
- **(4) 国内外の「CoderDojo」に関する普及および゙広報に関する活動**
   ...
   - 実例: [📣 NGOsource による認証を取得し、米国の財団等と協力・連携を進めやすい体制に。 - Facebook](https://www.facebook.com/coderdojo.jp/posts/pfbid02HfUfk8L9jgDkpPL5nmBYqyhtVHrx2xmqLhM16jUbFbx5EcX7U8eCaw8GFaW3kQ8Ql)
   - 実例: [📣 プログラミングでポケモンを動かすワークショップが、全国のCoderDojoで実施可能に。 - X (旧: Twitter)](https://x.com/CoderDojoJapan/status/1385460981883498499)<br><br>

- **(5) 国内外の「CoderDojo」の活動を通じて得られた知見の共有**
   - 内容: CoderDojo コミュニティで得られた知見をオープンに共有します
   - 詳細: ラズベリーパイ財団 CEO との対談、CoderDojo 共同設立者 (James, Bill) との対談、ポケモンワークショップなど。詳細は[公式 YouTube チャンネル](https://www.youtube.com/@CoderDojoJapan/playlists)をご参照ください
   - 実例: [📺 CoderDojo とは? (初めての人へ) - YouTube](https://www.youtube.com/playlist?list=PL94GDfaSQTmKzw7RLjbmUgl8VyfBR9E8e)
   - 実例: [📺 ポケモンワークショップの事例紹介 - CoderDojo Japan](/pokemon/workshop)<br><br>
- **(6) 前各号に附帯関連する一切の事業**
   - 内容: 法人として必要な事務作業や、今後のためにやっておくべきことを実施します
   - 詳細: [決算書の作成](/finances)、[理事の募集](#next)、[問い合わせ対応](/#inquiry)、[Global Partner Meetup への参加](https://note.com/kiriem/n/n24edde165b02)、[Clubs Conference の参加](https://note.com/kiriem/n/n8b2f2b7e8cbb)、[CoderDojo & Raspberry Pi Foundation](https://www.raspberrypi.org/blog/raspberry-pi-and-coderdojo-join-forces/) とのミーティング (英語) など
   - 実例: [📜 CoderDojo Japan - パートナーシップのご案内](/partnership)
   - 実例: [📜 CoderDojo Japan - 決算報告書](/finances)<br><br>


CoderDojo Japan が実施している上記活動、ならびに [CoderDojo & Raspberry Pi Foundation](https://www.raspberrypi.org/blog/raspberry-pi-and-coderdojo-join-forces/) が行なっている活動の一部はオープンになっているため、<b>理事にならなくても参画できる活動は多い</b>です。<small>(例: [翻訳ボランティアコミュニティ](https://www.raspberrypi.org/translate/)、[DojoLetterの編集](https://news.coderdojo.jp/category/dojoletterバックナンバー/)、[Webシステムの開発](https://github.com/coderdojo-japan)など)</small>

<br>

一方、パートナー法人と足並みを揃えて[プレスリリースを出す](https://prtimes.jp/main/html/searchrlp/company_id/38935)場合など、取り組みの実現に向けて秘密情報を保持しながら動くこともあります。さらに具体的な活動については、下記「[定例会の実施](#meeting)」をご確認ください。
...
## [👥](#meeting) 定例会の実施 {#meeting}

CoderDojo Japan では、定期的にオンラインでミーティングを実施しています（以下、定例会）。定例会では、主に理事メンバーによる意思決定や状況共有などを行いますが、理事以外からの意見を求めたい場面では全国の CoderDojo 代表者が集まるグループや、相談役である [@tkc49](https://twitter.com/tkc49) さんなどから意見をいただくこともあります。

<br>

定例会の様子をまとめた動画『[DojoCast#026](/podcasts/26)』もあるので、さらに詳しい様子については以下からご確認いただけます。
...
<blockquote>
  📝
  上記は2021年に収録した動画となります。最新の状況とは異なる場合がある点にご注意ください。
</blockquote>
...
### Q. 理事は何をしていますか?
- **A.** 冒頭にある「[活動内容](#works)」の指針をベースに、定期的にミーティング (定例会) を実施し、状況共有や意思決定、およびその実現に向けた作業を進めています。定例会は原則オンラインで行われ、これまでのところ、平日の日中に時間を合わせて実施することが多いです。具体的な雰囲気は上記「<a href="#meeting">定例会の実施</a>」をご参照ください 👥

### Q. 理事に給料や保険適用はありますか？
- **A.** いいえ、2020年7月時点では、給料支払いや社会保険の適用はなく、従業員ではなく、いわゆる役員という形式になります (社団法人のため、正確には[役員ではなく社員](http://www.moj.go.jp/MINJI/minji153.html)と呼びます) 。今後変わる可能性はゼロではないですが、現時点では予定しておりません。その代わり、理事の義務や負担を極力小さくし、主体的に動きやすい体制 (自身のやることを自身で決められる体制) を基本としています。
...
### Q. 理事ではなく、法人としてパートナーシップを結べますか？
- **A.** ご興味を持っていただきありがとうございます。**法人向けの情報は[パートナーシップのご案内](/partnership)**というページにまとめてありますので、そちらをご確認いただけると幸いです。


### Q. 理事の募集はしていますか?
- **A.** **現在は公開での募集は行っておらず、既存の理事メンバーなどからお声掛けする形を採っております。**[公開募集を行っていた当時の様子](#apply)を以下にまとめておきますので、ご参考になれば幸いです。

<!--チャンピオンやメンターなど、CoderDojo の運営側に関わったことがある方だと望ましいですが、必須条件とはしておりません。既存のメンバーとは異なる分野・価値観を持っている、地域的に分散している (東京都・千葉県以外にいる)、取り組みたいことが明確で主体的に動いていただけると期待できる、などを総合的に考え、判断したいと考えております。-->
...
## [✅](#apply) 公募していた当時の様子 _(現在、公募はしておりません)_ {#apply}
